...
class Booking extends Component
{
    ...
    {
        CustomerBookings::whereIn('uuid', $this->selectedRows)->delete();

        $this->dispatchBrowserEvent('success', ['message' => 'All selected bookings
            were deleted']);
    ...
    {
        CustomerBookings::whereIn('uuid', $this->selectedRows)->update(['status' => false]);

        $this->dispatchBrowserEvent('success', ['message' => 'All selected booking were marked as disabled']);
    ...
    {
        CustomerBookings::whereIn('uuid', $this->selectedRows)->update(['status' => true]);
        
        $this->dispatchBrowserEvent('success', ['message' => 'All selected booking
            were undisabled']);
