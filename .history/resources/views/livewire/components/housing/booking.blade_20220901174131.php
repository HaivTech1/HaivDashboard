                ...
                <div class="row mt-2">
                    ...
                    <div class="o-features">
                        <ul class="ul-list third-row" style="list-style-type: none">
                            ...
                            <li>
                                <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                    <input class="form-check-input" type="checkbox" id="furnish" name="furnish[]" value="cleaning">
                                    <label class="form-check-label" for="furnish">
                                        Cleaning
                                    </label>
                                </div>
                            ...
                            <li>
                                <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                    <input class="form-check-input" type="checkbox" id="furnish" name="furnish[]" value="fumigation">
                                    <label class="form-check-label" for="furnish">
                                        Fumigation
                                    </label>
                                </div>
