<div>
                        ...
                        <table class="table align-middle table-nowrap table-check">
                                ...
                                <tr>
                                    <th style="width: 20px;" class="align-middle">
                                        <div class="form-check font-size-16">
                                            <input class="form-check-input" type="checkbox" id="check" wire:model="selectPageRows">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <livewire:components.toggle-button :model='$booking' field='status'
                                                    :wire:key='$booking->id()' />
                                    </td>
                                    <td>
    ...
    @if ($booking_detail)
    <div id="details" class="modal fade" tabindex="-1" aria-labelledby="#details" aria-hidden="true" wire:ignore>
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h1 class="text-lg mt-4">
                        <i class="bx bx-credit-card-alt text-primary me-1"></i> 
                        {{ number_format( $booking_detail->total(), 2) }}
                    </h1>
