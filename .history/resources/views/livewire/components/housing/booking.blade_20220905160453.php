        ...
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <h5 class="font-size-15 mt-4">Booking Details :</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="text-muted mt-4">
                                ...
                                <p><i class="bx bx-phone-outgoing text-primary me-1"></i> {{ $booking_detail->name() }}</p>
                                <p><i class="bx bx-credit-card-alt text-primary me-1"></i> {{ number_format( $booking_detail->total(), 2) }}</p>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="table-responsive">
