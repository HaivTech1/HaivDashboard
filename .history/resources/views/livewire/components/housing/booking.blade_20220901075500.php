            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="d-flex mt-3">
                        ...
                        <span class="text-bold font-semibold text-primary uppercase ml-2">Get Amenities update</span>
                    </div>
                        ...
                        <ul class="ul-list third-row" style="list-style-type: none">
                            <li>
                                <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                    <input class="form-check-input" type="checkbox" id="furnish" name="furnish[]" value="logistics">
                            ...
                            <li>
                                <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                    <input class="form-check-input" type="checkbox" id="furish" name="furish[]" value="cleaning">
                                    <label class="form-check-label" for="furish">
                                        Cleaning
                                    </label>
                                </div>
                            </li>
                            ...
                            <li>
                                <div class="form-check form-checkbox-outline form-check-primary mb-3">
                                    <input class="form-check-input" type="checkbox" id="furish" name="furish[]" value="fumigation">
                                    <label class="form-check-label" for="furish">
                                        Fumigation
                                    </label>
                                </div>
