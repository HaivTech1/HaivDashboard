<div class="card">
    <div name="card-body">
        ...
        <div name="content">
            ...
            <div class="mt-5">
                @if (! $this->enabled)
                    <div wire:then="enableTwoFactorAuthentication">
                ...
                @else
                    @if ($showingRecoveryCodes)
                        <div wire:then="regenerateRecoveryCodes">
                            <button class="mr-3">
                                {{ __('Regenerate Recovery Codes') }}
                            </button>
                        </div>
                    @elseif ($showingConfirmation)
                        <div wire:then="confirmTwoFactorAuthentication">
                            <x-jet-button type="button" class="mr-3" wire:loading.attr="disabled">
                                {{ __('Confirm') }}
                            </x-jet-button>
                        </div>
                    @else
                        <div wire:then="showRecoveryCodes">
                            <button class="mr-3">
                    ...
                    @if ($showingConfirmation)
                        <div wire:then="disableTwoFactorAuthentication">
