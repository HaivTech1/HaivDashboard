<x-app-layout>
                    ...
                    <form id="createProperty" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div id='map' style='width: 250; height: 300px;'></div>
                                </div>
                            </div>
    ...
    @section('scripts')
        ...
        <script>
            mapboxgl.accessToken = 'pk.eyJ1IjoibWlkc2hvdDE3IiwiYSI6ImNsMzhvb21hOTAwNmkzZHFmaTR2ZXd4cmYifQ.PGTwJpHpA3xAeF6oZ_iZ0Q';
            const map = new mapboxgl.Map({
                container: 'map', // container ID
                style: 'mapbox://styles/mapbox/streets-v11', // style URL
                center: [4.8252, 7.0737], // starting position [lng, lat]
