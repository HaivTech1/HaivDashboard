<x-app-layout>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div id='map' style='width: 1020px; height: 300px;'></div>
                    </div>
                    ...
                    <form id="createProperty" role="form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-sm-6 mb-3"><span id="latitude"></span>
    ...
    @section('scripts')
        ...
        <script>
            ...
            //         const content = `
            //             <div style="overflow-y: auto; max-height: 400px; width:100px">
            ...
            //                         <tr>
            //                             <td>Image</td>
            //                             <td><img src="${image[0]}" loading="lazy" class="omg-fluid" /></td>
            //                         </tr>
            //                         <tr>
            //                             <td>Description</td>
            //                             <td>${description}</td>
            ...
            //         .setLngLat(geometry.coordinate)
            //         .setPopup(popUp)
            //         .addTo(map)
            //     });
            // };

            // loadLocations(<?php $geoJson ?>);
